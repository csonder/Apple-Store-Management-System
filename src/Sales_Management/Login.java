            ...
            //1=CUSTOMER
                ...
                //0=LOGIN
                    ...
                    while (!customerLogin) {
                        ...
                        String customerUsernameInput = JOptionPane.showInputDialog(null,"Username:","Customer Login", JOptionPane.QUESTION_MESSAGE);
                        if (customerUsernameInput == null) {
                        	break;
                        }

                        String customerPasswordInput = JOptionPane.showInputDialog(null,"Password:","Customer Login", JOptionPane.QUESTION_MESSAGE);
...
//CUSTOMER MENU METHOD ------------------
                ...
                //1=SIGNUP
                    ...
                    //Email
                    String newEmail = JOptionPane.showInputDialog(null,"Enter email:","Customer Signup", JOptionPane.QUESTION_MESSAGE);
                    if (newEmail == null) {
                    ...
                    //Name
                    String newCustomer = JOptionPane.showInputDialog(null, "Enter full name:","Customer Signup", JOptionPane.QUESTION_MESSAGE);
                    if (newCustomer == null) {
                        int confirm = JOptionPane.showConfirmDialog(null, "Cancel registration?", "Confirm", JOptionPane.YES_NO_OPTION);
                        if (confirm == JOptionPane.YES_OPTION) continue;
                    ...
                    //Username
                    String newUser = JOptionPane.showInputDialog(null,"Enter new username:","Customer Signup", JOptionPane.QUESTION_MESSAGE);
                    if (newUser == null) {
                        int confirm = JOptionPane.showConfirmDialog(null, "Cancel registration?", "Confirm", JOptionPane.YES_NO_OPTION);
                        if (confirm == JOptionPane.YES_OPTION) continue;
                    }
                    ...
                    //Password
                    String newPass = JOptionPane.showInputDialog(null,"Enter new password:","Customer Signup", JOptionPane.QUESTION_MESSAGE);
                    if (newPass == null) {
                        int confirm = JOptionPane.showConfirmDialog(null, "Cancel registration?", "Confirm", JOptionPane.YES_NO_OPTION);
                        if (confirm == JOptionPane.YES_OPTION) continue;
                    }
